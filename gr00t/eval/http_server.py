#!/usr/bin/env python3
"""
DIAL HTTP Server Module

This module provides HTTP server functionality for DIAL model inference.
...
class HTTPInferenceServer:
    def __init__(
        ...
        """
        A simple HTTP server for DIAL models; exposes `/act` to predict an action for a given observation.
        ...
        self.app = FastAPI(title="DIAL Inference Server", version="1.0.0")
    ...
    def health_check(self) -> Dict[str, str]:
        ...
        return {"status": "healthy", "model": "DIAL"}

    def run(self) -> None:
        """Start the HTTP server."""
        print(f"Starting DIAL HTTP server on {self.host}:{self.port}")
